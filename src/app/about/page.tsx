...
import { getAbout, type About, type I18N } from "@/services/AboutService";
import {
...
export default function GioiThieuPage() {
    ...
    (async () => {
      try {
        ...
        if (!err?.message?.includes("No rows")) {
          toast.error("Không tải được nội dung About");
        }
      } finally {
        setIsLoading(false);
      }
  ...
  useEffect(() => {
    if (!about) return;
    const rawHtml =
      about.content?.[L] || about.content?.vi || about.content?.en || "";
    ...
    <div className="w-full">
      <style jsx global>{`
        ...
        /* ══════════════════════════════════════
           Highlight Block
        ══════════════════════════════════════ */
        .about-content div[data-type="highlight-block"] {
        ...
        .about-content div[data-type="highlight-block"] ul {
          list-style: none;
          margin: 0.25rem 0 0 0;
          padding-left: 0;
        }
        .about-content div[data-type="highlight-block"] ul li {
          position: relative;
          padding-left: 1.5rem;
          margin-bottom: 0.4rem;
          line-height: 1.7;
        }
        .about-content div[data-type="highlight-block"] ul li::before {
          content: "•";
          position: absolute;
          left: 0;
          color: #06446a;
        ...
        .about-content div[data-type="highlight-block"] ol {
          counter-reset: item;
          list-style: none;
          margin: 0.25rem 0 0 0;
          padding-left: 0;
        }
        .about-content div[data-type="highlight-block"] ol li {
          position: relative;
          padding-left: 2rem;
          margin-bottom: 0.4rem;
        ...
        .about-content div[data-type="highlight-block"] ol li::before {
        ...
        .about-content div[data-type="highlight-block"] p {
          margin-bottom: 0.4rem;
          text-align: left;
        }
        .about-content div[data-type="highlight-block"] p:last-child {
          margin-bottom: 0;
        }
        .about-content div[data-type="highlight-block"] strong,
        .about-content div[data-type="highlight-block"] b {
          font-weight: 700;
          color: inherit;
        }
        .about-content div[data-type="highlight-block"] a {
          color: #06446a;
          text-decoration: underline;
          text-decoration-color: #e7bf64;
          text-underline-offset: 3px;
        }
        .about-content div[data-type="highlight-block"] a:hover {
          color: #e7bf64;
        }
        .about-content div[data-type="highlight-block"] h1,
        .about-content div[data-type="highlight-block"] h2,
        .about-content div[data-type="highlight-block"] h3 {
          color: #06446a;
          margin-top: 0;
